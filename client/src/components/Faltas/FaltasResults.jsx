...
const FaltasResults = ({ results, deleteAction, setModalContent }) => {
              ...
              {results.map((falta, index) => {
                return (
                  <tr key={index} className="bg-indigo-50">
                    <td className="px-2 py-1">{falta.funcionario.nome}</td>
